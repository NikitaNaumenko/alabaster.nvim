...
if vim.o.background == "dark" then
    ...
    theme = {
        ...
        TSFunction = { fg = ansi.blue },
        TSFuncBuiltin = { fg = ansi.blue },
        TSFuncMacro = { fg = ansi.blue },
        ...
        ["@field"] = { fg = ansi.black },
        ["@function"] = { fg = ansi.blue },
        ["@function.builtin"] = { fg = ansi.blue },
        ["@function.macro"] = { fg = ansi.blue},
        ["@keyword"] = { fg = ansi.black },
